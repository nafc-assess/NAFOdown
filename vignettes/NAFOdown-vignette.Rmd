---
title: "NAFOdown: An R package for Creating NAFO Scientific Council Documents"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{NAFOdown: an R package for creating NAFO documents}
...
```{r logo, echo = FALSE, out.width = "150px", out.height = "150px", out.extra='style="float:right; padding:10px"', eval = knitr::is_html_output()}
