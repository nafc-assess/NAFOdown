...
```{r pa-leaf, fig.asp = 1, fig.width = NAFOdown::.nafo_width, dpi = 600}
Bmsy <- 1
Blim <- 0.3 * Bmsy
Btrigger <- 0.75 * Bmsy
Fmsy <- 1
...
---
nocite: | 
  @scr20-005, @scr20-042, @scr20-050, @scs20-14a, @scs20-14b, @scs20-011, @scr21-020, @scr21-026, @scr22-013, @scr22-015, @scr22-016, @scr22-042, @scr22-043, @scr23-001, @scr23-007, @scr23-014
...
